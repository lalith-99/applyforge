...
func TestClassifyTitle(t *testing.T) {
	cases := []struct {
		...
		{"Manager/Software Engineering", "EXCLUDED", "NON_SOFTWARE"},
		{"Technical Manager - Java Platform", "EXCLUDED", "NON_SOFTWARE"},
		{"Senior QA Test Engineer", "EXCLUDED", "NON_SOFTWARE"},
		{"QA|Automation Engineer", "EXCLUDED", "NON_SOFTWARE"},
		{"Test Automation Engineer", "EXCLUDED", "NON_SOFTWARE"},
		{"Performance Test Engineer", "EXCLUDED", "NON_SOFTWARE"},
		...
		{"Product Owner", "EXCLUDED", "NON_SOFTWARE"},
		{"Product Designer", "EXCLUDED", "NON_SOFTWARE"},
		{"UX Designer", "EXCLUDED", "NON_SOFTWARE"},
		{"Data Scientist", "EXCLUDED", "NON_SOFTWARE"},
		{"Research Scientist", "EXCLUDED", "NON_SOFTWARE"},
		{"Database Administrator", "EXCLUDED", "NON_SOFTWARE"},
		{"Systems Administrator", "EXCLUDED", "NON_SOFTWARE"},
		{"Network Engineer", "EXCLUDED", "NON_SOFTWARE"},
		{"Desktop Support Engineer", "EXCLUDED", "NON_SOFTWARE"},
		...
		{"Front-End Engineer", "FRONTEND", "IC_SOFTWARE"},
		{"UI Developer", "FRONTEND", "IC_SOFTWARE"},
		{"Platform Engineer", "PLATFORM", "IC_SOFTWARE"},
		{"Kubernetes Engineer", "PLATFORM", "IC_SOFTWARE"},
		{"Cloud Developer", "CLOUD", "IC_SOFTWARE"},
		{"Data Platform Engineer", "DATA_ENGINEERING", "IC_SOFTWARE"},
		{"MLOps Engineer", "ML_ENGINEERING", "IC_SOFTWARE"},
		{"Distributed Systems Engineer", "SYSTEMS", "IC_SOFTWARE"},
		{"Systems Engineer, Software", "SYSTEMS", "IC_SOFTWARE"},
		...
		{"Software Consultant", "CONSULTING_ENGINEERING", "IC_SOFTWARE"},
