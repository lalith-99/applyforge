...
func toResponse(p Profile) map[string]any {
	return map[string]any{
		...
		"state":                         p.State,
		"country":                       p.Country,
		"primary_target_titles":         orEmpty(p.PrimaryTargetTitles),
		"alternative_target_titles":     orEmpty(p.AlternativeTargetTitles),
		"seniority":                     p.Seniority,
		"years_experience":              p.YearsExperience,
		"preferred_industries":          orEmpty(p.PreferredIndustries),
		"preferred_technologies":        orEmpty(p.PreferredTechnologies),
