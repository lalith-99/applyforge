...
SKILL_DICTIONARY: list[str] = [
    ...
    "Docker", "Kubernetes", "OpenShift", "Amazon ECS", "Terraform", "CloudFormation",
    "Infrastructure as Code", "Ansible", "Helm", "Istio", "AWS", "Azure", "GCP", "Cloudflare",
    "Jenkins", "GitHub Actions", "GitLab CI", "CircleCI", "CI-CD", "CI/CD",
    "Prometheus", "Grafana", "CloudWatch Metrics", "Datadog", "Monitoring", "Observability",
    "Spark", "Hadoop", "Airflow", "Pandas", "NumPy", "TensorFlow", "PyTorch",
    "Microservices", "WebSockets", "OAuth", "JWT", "Protobuf",
    "Linux", "Bash", "Git",
    "RAG", "Retrieval-Augmented Generation", "LangChain", "Amazon Bedrock", "OpenAI APIs",
    "LLMs", "LLM-based Systems", "Semantic Retrieval", "Claude Code", "Cursor",
    "Prompt Engineering", "Prompt Design", "Tool Calling", "Function Calling",
    "AI Agent Memory", "Agent Orchestration", "Agent Frameworks", "Agentic AI",
    "Model Context Protocol", "MCP", "MCP Servers", "AI Observability", "AI Evaluation",
    "Context Pipelines", "Retrieval Pipelines",
    "Automated Testing Frameworks", "API Testing", "Integration Testing", "Data Pipeline Testing",
    "Test Automation",
]
