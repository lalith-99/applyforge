...
_SYSTEM_PROMPT = (
    ...
    "belongs in UI metadata, never in the resume sentence. Prefer a companion experience rewrite "
    "for each AI_SUGGESTED skills-section addition when the skill can be integrated coherently. "
    "A standalone skill suggestion is acceptable and should not by itself trigger regeneration. "
    "Prefer concise human-written bullets "
