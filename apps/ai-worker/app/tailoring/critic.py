...
_SYSTEM_PROMPT = (
    ...
    "evidence. source=AI_SUGGESTED with risk=HIGH is an attestation-gated draft: it may introduce a "
    ...
    "team sizes, promotions, or implausible business outcomes. Review whether each draft maps to an "
    "actual required/preferred skill or responsibility and whether the technical scenario is coherent "
    "with the original role context. Flag weak_bullets when text sounds AI-generated, generic, "
    "keyword-stuffed, or uses resume-inappropriate phrases such as 'learning', 'building proficiency', "
    "'gaining exposure', 'growth area', 'transferable to', 'applicable to this role', or verification "
    "disclaimers. Candidate-attestation language belongs in UI metadata, never in the resume sentence. "
    "Prefer concise human-written bullets with action + technical implementation + impact; reuse only "
    "metrics/outcomes already present in source material. Flag missing_high_value_keywords, repetition, "
